...
signal_cal_factors_ch = cal_factors_ch(1);
noise_cal_factors_ch = cal_factors_ch(2);
  
signal_power_dbm = signal_power_14bit_db+signal_cal_factors_ch;
noise_power_dbm = noise_power_14bit_db+noise_cal_factors_ch;
...
noise_avg = mean(mean(noise_power_watts));
snr_db = pow2db(signal_power_peak/noise_avg);
