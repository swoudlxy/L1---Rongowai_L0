...
function surface_type = get_surf_type(P,cst_mask,pek_mask,lcv_mask)
...
% process landcover type
dist_coast = get_map_value(lat_P,lon_P,cst_mask);

if dist_coast <= 0
    surface_type = -1;               % coordinate on ocean
...
elseif dist_coast > 0
    ...
    if pek_value > 0
        ...
        surface_type = get_landcover_type(lat_P,lon_P,lcv_mask);
