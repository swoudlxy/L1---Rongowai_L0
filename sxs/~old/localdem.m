...
% loop over local dem and replace ocean elevation with DTU10 MSS
for m = 1:num_grid
    for n = 1:num_grid
...
for m = 2:num_grid-1
    for n = 2:num_grid-1
        ...
        dA(m-1,n-1) = sidelength1*sidelength2*1e6/4;    % size in square meter
