...
% L1a correction to new calibration table - 28 Oct 2023
L1a_cal_ddm_counts_dB = readmatrix([L1a_path 'L1A_cal_ddm_counts_dB_v3.dat']);
L1a_cal_ddm_power_dBm = readmatrix([L1a_path 'L1A_cal_ddm_power_dBm_v3.dat']);
